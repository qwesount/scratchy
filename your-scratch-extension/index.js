...
class Scratch3YourExtension {
    ...
    getInfo () {
        return {
            ...
            // icons to display
            blockIconURI: 'your-extension-icon.png',
            menuIconURI: 'your-extension-icon.png',
    ...
    myFirstBlock ({ MY_NUMBER, MY_STRING }) {
        ...
        return MY_STRING + ' : added ' + (MY_NUMBER);
    }
}
